...
//    }
    ...
    static ResourceLocation getDefaultRecipeId(ItemLike itemLike) {
        return new ResourceLocation(DecorAndMore.MODID, Registry.ITEM.getKey(itemLike.asItem()).getPath());
...
//        return Registry.ITEM.getKey(itemLike.asItem());
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation p_176504_) {
        ...
        consumer.accept(new DyedRecipeBuilder.Result(p_176504_,
                ...
                new ResourceLocation(DecorAndMore.MODID, "recipes/" + p_176504_.getPath())));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return DecorRecipes.DYED_CRAFTING_SERIALIZER.get();
        }
