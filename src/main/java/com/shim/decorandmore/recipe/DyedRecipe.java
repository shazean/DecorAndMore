package com.shim.decorandmore.recipe;
...
public class DyedRecipe implements CraftingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingContainer> {
...
//    }
    ...
    public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<RecipeSerializer<?>>  implements RecipeSerializer<DyedRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(DecorAndMore.MODID,"dyed_crafting");
